          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-slate-100 gap-3">
            <div>
              <h3 className="text-base font-bold text-slate-900">
                Struktur &amp; Bank Soal Bahasa Indonesia ({questions.length} Butir)
              </h3>
              <p className="text-xs text-slate-500">
                20 Soal Pilihan Ganda (PG Bergambar), 10 Soal Benar / Salah (Bergambar)
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              {onResetDefaultQuestions && (
                <button
                  ...
                  onClick={() => {
                    if (
                      confirm(
                        'Kembalikan seluruh bank soal ke 30 butir standar Bahasa Indonesia (20 PG, 10 Benar/Salah)?'
                      )
                    ) {
                      onResetDefaultQuestions();
                    }
