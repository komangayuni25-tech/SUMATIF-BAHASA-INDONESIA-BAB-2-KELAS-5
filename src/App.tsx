 ...
 * Mata Pelajaran: BAHASA INDONESIA (Kalimat Langsung & Tak Langsung, Unsur Cerita & Majas, Buku Fiksi & Nonfiksi)
 */
...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_b_indo_v1';
...
export default function App() {
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan 30 soal (20 PG, 10 Benar/Salah)
  ...
  // Reset soal ke 30 butir standar Bahasa Indonesia (20 PG, 10 Benar/Salah)
